...
# Bot command to list all upcoming events
...
async def list_events(ctx):
    ...
    if upcoming_events:
        ...
        for event in upcoming_events:
            event_id = event['id']
            event_details = get_event_details(event_id)  # Corrected function call

            if event_details:
                event_name = event_details['name']
                description = event_details['description']
                username = event_details['user']['username']
                scheduled_start_time = event_details['scheduled_start_time']
                scheduled_end_time = event_details['scheduled_end_time']
                ...
                event_info = (
                    ...
                    f"Username: {username}\n"
                    f"Scheduled Start Time: {scheduled_start_time}\n"
                    f"Scheduled End Time: {scheduled_end_time}\n"
                )
