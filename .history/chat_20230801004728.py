...
# Command t# Command to create an event and add it to the list
# Command to create an event and add it to the list
@bot.command(name='createevent')
async def create_event(ctx, name, start_time_str, end_time_str, description):
    # Convert start_time and end_time from string to datetime objects
    start_time = datetime.fromisoformat(start_time_str)
    end_time = datetime.fromisoformat(end_time_str)

    # Your code to create an event object
    event = {
        "name": name,
    ...
    await ctx.send(f"Event '{name}' has been created.")
