...
async def list_events(ctx):
    ...
    if upcoming_events:
        ...
        for event in upcoming_events:
            ...
            if event_details:
                print("Event Details:", event_details)  # Print to inspect the structure
                # Access the relevant keys in event_details and construct event_info
                
                event_info = (
                    # Construct event_info based on the available keys
                )
