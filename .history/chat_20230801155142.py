...
@bot.command(# Function to create an event and add it to the calendar
def create_event(name, start_time, end_time, description):
    global event_counter
    event = {
        'name': name,
...
# Command to create an event
@bot.command()
async def create(ctx, name, start_time, end_time, description):
    response = create_event(name, start_time, end_time, description)
