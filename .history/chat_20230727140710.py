...
class DiscordEvents(commands.Cog):
    ...
    async def create_guild_event(
        ...
        # Rest of the method remains unchanged as provided in your original code
        # ...
...
async def add_event(ctx, name, start_time, end_time, description):
    ...
    async with guilded.Client(TOKEN) as client:
        created_event = await client.create_event(event)
    
    await ctx.send(f"Created Guilded event: {created_event.name}")
# Add Task
