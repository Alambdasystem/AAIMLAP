...
import discord
import pandas as pd
from discord.ext import commands,tasks,Bot
import openai
import csv
import asyncio
import re
...
async def on_ready():
    ...
    # Get the guild (server) the bot is connected to
    guild = bot.guilds[0]  # Assuming the bot is connected to only one guild
