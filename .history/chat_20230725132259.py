...
import aiohttp
import guilded
from guilded.models import Event
...
async def add_task(ctx):
    ...
    await ctx.send("Please provide the deadline for the task (in the format YYYY-MM-DD):")
    ...
    event_start_time = deadline + "T00:00:00"
    event_end_time = deadline + "T23:59:59"
