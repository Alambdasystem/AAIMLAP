...
async def add_task(ctx):
    print("Add task command invoked.")
    ...
    try:
        ...
        print(f"Received task description: {description_message.content}")
        ...
        print(f"Received assignee: {assignee_message.content}")
        ...
        print(f"Received deadline: {deadline_message.content}")
